...
class AppRouterDelegate extends RouterDelegate<RouteConfiguration>
  ...
  final GlobalKey<State<LoginScreen>> navigationTabKey = GlobalKey<State<LoginScreen>>();

  LoginScreen get navigationTabState => navigationTabKey.currentState as LoginScreen;
